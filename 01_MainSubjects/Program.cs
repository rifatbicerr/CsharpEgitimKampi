...
namespace _01_MainSubjects
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //customerPhone = "+90 500 300 30 20";
            ...
            int totalPrice= totalCokePrice+totalWaterPrice+totalLemonatePrice+totalHamburgerPrice+totalPizzaPrice+totalFriesPrice;
